...
class PersonX_Spgan(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, **kwargs):
        ...
        query = self.process_dir(query_path, './data/challenge_datasets/target_test/index_test_gallery.txt')
        gallery = self.process_dir(gallery_path, './data/challenge_datasets/target_test/index_test_query.txt')
